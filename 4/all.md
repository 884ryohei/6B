...
----
  ...
  公刊の倫理的，法的基準
  多くの執筆手引きは科学的な書き方を扱っている．書き方には本質的には正しいとか間違っているという意味はない．それは単にコミュニケーションを円滑にするためにデザインされた情報を提示する習慣的な方法にすぎない．異なる学問体系では異なる書き方がある．
  対して，基本的な倫理的．法的規則はすべての学問研究と筆耕に横たわっている．それらの長らく掲げられている規則は，3つの目標に到達するために設計されている．
  ・科学的知識の正確性を保証するため，
  ・研究対象の権利と福祉を確保するため，そして
  ・知的所有権を守るため
  社会科学や行動科学の著者は，これらの目標を維持するために働き，彼らの専門的な委員会で打ち立てられた規則に従う．以下の手引きは，科学的データの報告と公刊を扱う基準を含む「心理学者の倫理規定と行動綱領」(以下にAPA倫理綱領，APA, 2002として引用する．http://www.apa.org/ethicsも見よ)に書かれている．APA倫理綱領は確定した文章ではなく，時とともに修正されたり，更新されるかもしれない点に留意せよ．更新はそれが利用可能になったときにウェブ上に公開される．

  科学的知識の正確性を保証する
  1.07 研究成果の倫理的報告
  科学的方法の本質は他の研究者によって再現され，実証できる対象であることを意味する．従って，心理学者はデータを捏造したり改竄しない(APA倫理綱領基準8.10a, 研究結果の報告)．視覚的なイメージ(視覚的なイメージにおけるさらなる議論は第5章5.29章を見よ)を含む，仮説を指示させたり，説得的な話を展開するために問題を起こす対象を報告から捨象する結果の編集も禁止されている(APA倫理綱領基準5.01a，不正や虚偽の報告の忌避．)
  公刊のための原稿を入念に準備することは基本であるが，それでも間違いは起こる．著者らは公刊後にそれらの間違いに気づいたことを公表する責任を負っている．第一に，エディターと出版社に訂正報を載せられるように伝えなさい．それらの訂正報の目的は間違いに基づいた知識を正すことで，その情報の将来の利用者に注意を促すことにある．どの訂正報もオンラインデータベース上で原著に付記されることで修正され，原著が修正されることはない(訂正報に関するさらなる内容は8.06章APA倫理綱領基準8.10b研究結果の報告を見よ)．

  1.08　データ保存と共有
  研究者らはもしその報告の正確性を尊重する上で疑念が生じた場合には自分たちのデータを査読中と公刊過程はいつでもエディターが利用できるようにすべきである．それを拒否することは投稿した原稿をこれ以上の考慮なしに拒否する結果を招く．同じ文脈で，一度論文が公刊されたら，研究者は分析と結果を確認する他の専門家の検証を許可するためにそのデータを利用できるようにすべきである(APA倫理綱領基準8.14a，検証のための研究データの共有)．著者らは，研究の公刊後最低5年間は生データを保存することが期待される．研究に関する他の情報(例えば指示書，処置手引き，ソフトウェア，手続内容，学術論文で報告された数学モデルのコード)は同じ期間保持されなければならない．そのような情報は他人が複製を試みたり，研究者の要求に応じて提供すべき時に必要とされる．(APA倫理綱領基準6.01，専門的で科学的な研究の書類と記録の管理)．
  APAは公認された研究者間でのデータの公開共有を推奨する．著者らは，他の研究者からのデータ共有の要望に協力の精神で速やかに対応することが期待される．データ共有の前には，いかなる個人を特定できる情報をも消去するか，被験者個人が同定できるようにリンクが再設定できるようにコーディングする．研究被験者の秘密を守ることに加えて，特殊な所有や研究者のその他の懸念，研究のスポンサーも時に丁寧に指摘するべきである．一般的には，要求に従う費用は要求者がねん出すべきである．
  誤解を避けるために，研究者がデータを要求することが重要であり，データを提供する研究者は共有されるデータの条件について同意文を書くことようになる．そのような同意は，共有されたデータがどのように使われるべきかの制限を特定(例えば，既刊論文の結果を検証するため，メタ分析研究に貢献するため，二次分析のため)するべきである．書かれた同意文は共有されたデータの頒布についての制限の形式的な文面も含んでいなければならない(例えば，そのデータを要求した人のみ使えるとか，要求した人とその指導者は使えるとか，そのデータの頒布は無制限であること)．さらに，同意文は公表範囲における制限も特定しなければならない(研究会のプレゼンテーション，内部報告書，学術論文，本の章など)．データ共有は著作権制限の適切な取り扱いに従い，被験者によって提供された承諾，資金を供出した代理人の要求，そしてそのデータの所有者の従事者によって発布されたルールを調整しなければならない．
